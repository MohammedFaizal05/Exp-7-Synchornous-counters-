...
### Procedure
 ...
 1.Compile and run the verilog program in the quartus software.
 
 2.Realize the RTL logic for the same.
 
 3.Create a new university program vwf and import nodes using node finder.
 
 4.Run functional simulation to obtain the timing diagram.
